...
func (ni *NullInt64) Set(val int64) {
...
func (ni *NullInt32) Set(val int32) {
...
func (ns *NullString) Set(val string) {
...
// Nullable String that overrides sql.NullTime
...
func (nt *NullTime) Set(val time.Time) {
